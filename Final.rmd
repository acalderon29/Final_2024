...
Sexual orientation, substance use, and sex are the study's factors. We will utilize the Cat~Cat helper file because we want to determine whether drug effectiveness varies depending on the population subgroups: sex, drug usage, and sexual orientation are all categorical variables. 
